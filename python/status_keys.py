    ...
    'ccat' : {
        'status_fields' : {
            ...
            'axis_limits' : {
                ...
                'Azimuth CW limit: emergency': 'AzCW_HWlimit_emergency',
                'Azimuth CW limit: 2nd emergency': 'AzCW_HWlimit_2ndEmergency',
                'Elevation CCW limit: 2nd emergency': 'ElCCW_HWlimit_2ndEmergency',
                'Elevation Down limit: emergency': 'ElDown_HWlimit_emergency',
                'Elevation Down limit: operating': 'ElDown_HWlimit_operating',
                'Elevation Down limit: pre-limit': 'ElDown_HWprelimit',
                'Elevation Down limit: operating (ACU software limit)': 'ElDown_SWlimit_operating',
                ...
                'Elevation Up limit: operating': 'ElUp_HWlimit_operating',
                'Elevation Up limit: emergency': 'ElUp_HWlimit_emergency',
                'Elevation CW limit: 2nd emergency': 'ElCW_HWlimit_2ndEmergency',
                },
            'axis_faults_errors_overages' : {
                'Azimuth summary fault': 'Azimuth_summary_fault',
                'Azimuth motion error': 'Azimuth_motion_error',
            ...
            'platform_status' : {
                'Access Hatch 1 Interlock - Holography System': 'Interlock_AccessHatch1_Holography',
                'Access Hatch 2 Interlock - Holography System': 'Interlock_AccessHatch2_Holography',
                'Access Hatch Interlock - Support Cone': 'Interlock_AccessHatch_SupportCone',
                'Yoke A Door Waring - Outside to Stairway': 'Warn_YokeADoor_OutsideStairway',
                'Stairway Door Warning - Yoke Traverse': 'Warn_StairwayDoor_YokeTraverse',
                'Material Door Warning - Electronics Space': 'Warn_MaterialDoor_Electronics',
                'Yoke A Door Interlock - 1st Floor to Lift': 'Interlock_YokeADoor_1stFloorLift',
                ...
                'Material Door Warning - Instrument Space 2A/2B': 'Warn_MaterialDoor_Instrument2A2B',
                ...
                'Material Door Warning - Process Space': 'Warn_MaterialDoor_Process',
                'Yoke B Door Warning - 1st Floor': 'Warn_YokeBDoor_1stFloor',
            ...
            'corotator': {
                ...
                '3rd axis axis in stop': 'Corotator_stop',
                '3rd axis axis disabled': 'Corotator_disabled',
                '3rd axis brakes released': 'Corotator_brakes_released',
                '3rd axis axis in stow position': 'Corotator_stow_position',
                '3rd axis stow pins - status': 'Corotator_stow_pins_status',
                '3rd axis stop at LCP': 'Corotator_stop_LCP',
                '3rd axis power on': 'Corotator_power_on',
                '3rd axis CCW limit': 'Corotator_CCW_limit',
                '3rd axis CW limit': 'Corotator_CW_limit',
                '3rd axis summary fault': 'Corotator_summary_fault',
                },
            },
        },
    }
